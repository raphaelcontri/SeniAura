...
gdf_merged, variable_dict, category_dict, sens_dict, _, unit_dict, _, _ = load_data()
    ...
    children=[
        ...
        dmc.Paper(
            ...
            children=[
                ...
                dcc.Graph(id='radar-chart', style={'display': 'none', 'flex': 1, 'minHeight': 0}, config={'displayModeBar': False}),
